          ...
          <div className="container mx-auto">
            <div className="px-8 flex flex-col items-center pt-12">
              ...
              <div className="input-container py-3">
                <input className="w-96 h-10 py-2 px-3 rounded-xl mr-2 border focus-visible:outline-none focus-visible:border-green-600 focus-visible:border-opacity-70 outline-1 placeholder:font-light placeholder:tracking-wide placeholder:text-sm bg-gray-50" type="text" placeholder="A multicolor butterfly..." /> 
